...
// // 2 задание.
// void main() {
//   var numsTask2 = File('K:\\РКИС (дарт)\\gr621 madse\\RcisEducationPracticeOne\\work3\\Файлы для заданий\\2\\nums.txt');
...
// // Задание 3.
// void main() {
//   var numsTask2 = File('K:\\РКИС (дарт)\\gr621 madse\\RcisEducationPracticeOne\\work3\\Файлы для заданий\\3\\task3.txt');
//   var nums = numsTask2.readAsStringSync();
//   List<String> list = [];
//   List<int>  height = [];
//   int count = 0;
